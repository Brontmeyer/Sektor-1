...
Owned conventional equipment lives in party inventory, while equipped Weapon / Armor / Accessory IDs belong to actors. `Game_Party` is the physical-copy authority: a single owned copy cannot be shared by multiple actors, and candidate lists expose only copies available to the selected actor. Final equip / unequip mutation still terminates at actor APIs rather than direct field mutation.
