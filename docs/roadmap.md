...
- Save / Load with version-aware multi-actor Save Runtime v12, persistent area-location discovery plus learned Skills / Valor / Runes (legacy Gil field) / accessory equipment / slot-aware Essence / party-row state, v11 discovery migration, v9 row migration, and preserved v1-v8 starter-Valor-Art migration
