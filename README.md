...
-   ✅ Turn queue
-   ✅ Save / Load (version-aware Save Runtime v13)
...
The current Save Runtime v13 persists both equipped accessory IDs and party accessory inventory. The existing test chest can award a Power Wrist through the validated accessory event-command path.
